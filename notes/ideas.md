...
A creator shares a supposed 'secret' method for making money by creating AI-generated YouTube Shorts videos about GTA 6. He claims to copy descriptions from existing GTA 6 videos, use Claude AI to generate prompts, and then use Argil to create full AI videos to post on YouTube Shorts. He shows an estimated revenue of $53,910.23 as supposed proof of his earnings.

The video opens with the creator claiming he's reluctantly sharing a money-making secret that he'll delete in 24 hours to prevent too many people from copying him. He explains that GTA 6 is releasing on November 19th and there is massive internet traffic around the game. He outlines a step-by-step process: 1) Find a GTA 6 video on YouTube, 2) Copy its description, 3) Paste the description into Claude AI to generate a video prompt, 4) Use the camera/text feature to grab the text, 5) Paste everything into Argil AI to generate a full AI creative video, 6) Post the resulting video to YouTube Shorts to earn ad revenue. He claims YouTube pays $2,000–$10,000 per million views and shows a YouTube Studio dashboard displaying $53,910.23 in estimated revenue as evidence of his two-month results.

- Claims GTA 6 releasing November 19th creates high-traffic content opportunity
- Strategy involves copying YouTube video descriptions and feeding them into Claude AI for prompts
- Uses Argil AI tool to generate full AI videos from the prompts
...
Source: https://www.instagram.com/reel/Dau8Aysg2P3

A young man presents 10 niche habits to improve personal presence and composure, drawing on techniques from Navy SEALs, fighter pilots, Stoic philosophy, hostage negotiators, and poker pros. Each habit is paired with a cinematic reference image of iconic composed male characters. The advice focuses on breathing, eye control, voice pacing, stillness, and mental rehearsal.

The creator walks through 10 progressively niche habits designed to make one's presence commanding and unshakeable. Habit 1: Use extended exhales (twice as long as inhales) for two minutes before high-stakes moments, a Navy SEAL technique to lower heart rate and steady hands. Habit 2: Hold your gaze on a fixed point for 30 seconds before entering an important room, as fighter pilots train to keep eyes still, which signals dominance. Habit 3: Speak 50% slower than feels natural in at least one conversation daily, a technique voice coaches use for actors and politicians to signal ownership of the room. Habit 4: Sit in complete silence with no stimulation for 10 minutes daily, a Stoic practice that builds composure under pressure. Habit 5: Rehearse the worst-case scenario in detail the night before a big moment (Stoic 'premeditatio malorum') so nothing can rattle you. Habit 6: Drop your voice lower and quieter when tension rises rather than raising it, a hostage negotiator technique that draws people in. Habit 7: Keep hands completely still when being observed, as poker pros and elite interrogators track fidgeting as a signal of nerves. The video uses stills from Peaky Blinders, James Bond films, American Psycho, The Godfather, and Billions to visually reinforce the archetype of a composed, dominant man.

- Extend exhales to twice the length of inhales for 2 minutes before high-stakes moments to lower heart rate
- Hold gaze on a fixed point for 30 seconds before entering a room — still eyes signal dominance
- Speak 50% slower than natural in one conversation daily to project authority
- Sit in complete silence for 10 minutes daily to build composure (Stoic practice)
- Use premeditatio malorum — mentally rehearse worst-case scenarios the night before
- Lower your voice instead of raising it during tension; keep hands completely still when observed
...
## 2026-07-23 03:26 UTC
Source: https://www.instagram.com/reel/Da9gI01OYmq/
Creator: Tristan Natale

A young content creator ranks various online business models on a tier list from S to F, sharing personal experience with each. He covers day trading, dropshipping, SMMA/freelancing, TikTok Shop affiliate, AI agency, AI avatars for Amazon brands, and even working at Papa Johns. He ultimately promotes AI avatar Amazon affiliate marketing as his top pick.

The creator opens by claiming he has personally tried all the business models he's about to rank. He places day trading in F tier, arguing it's not a real business and that people who teach it only make money from coaching. Dropshipping gets B tier — he made his first $10K from it at 16 but notes organic reach is dead and you need expensive ads plus many skills. Freelance brand scaling/SMMA gets D tier due to low pay for high effort. TikTok Shop affiliate gets A tier — he's made five-figure months but dislikes the hamster wheel of finding products, risk of bans, and inability to truly scale. AI agency gets B tier — real but hard to get clients, requires deep AI knowledge, and is oversaturated. Papa Johns (actual job) gets F tier humorously. Finally, AI avatars as an Amazon brand affiliate gets S tier — no face required, software generates videos, high conversions due to Amazon trust, 100% commission when working directly with brands, and he shares anecdotes of a mom making $80K and a kid making $4K in their first week. He directs viewers to his page and bio link to learn more.

- Day trading ranked F tier — not a real business, teachers only profit from coaching
- Dropshipping ranked B tier — works but requires expensive ads and many skills
- TikTok Shop affiliate ranked A tier — good income but unsustainable hamster wheel
- AI agency ranked B tier — real but oversaturated and hard to land clients
- AI avatar Amazon affiliate ranked S tier — faceless, high commissions, high conversions
- Papa Johns employment ranked F tier (humorous personal experience)

⚠️ Reliability (hype: mild):
- [unverifiable] A mom made $80,000 and a kid made $4,000 in their first week using AI avatar Amazon affiliate — No evidence or screenshots are shown to support these specific earnings figures for third parties.
- [dubious] TikTok Shop affiliates cannot truly scale and mainly earn from old videos — Many TikTok Shop affiliates do scale through team content creation and live selling, contradicting this absolute claim.

<details><summary>Full transcript</summary>

ranking online business models, coming from someone who's tried them all day trading. I wish more people realized this isn't a business model more of just like a skill. And this skill is basically impossible to learn. All the people you see online making money day trading, really just make money from coaching. If you can genuinely click a couple buttons on your phone and piss out a million dollars a month, why would you ever show anyone else how to do that? Plus you need a lot of capital start, F tier, drop shipping. This is how I made my first $10,000 when I was 16. It's definitely a real business model and actually works, but organic is dead. So you need to spend thousands of dollars on ads. And there's just a lot of little stuff gurus don't tell you about. And it's not one skill you need to learn a ton of skills. B tier, freelance brand scaling, which is just another name for SMMA. Basically the amount of effort it takes to get one paying client, that's only paying you like one to $2,000. Just makes no sense. And if you spent all that time in a better business model, you'd make way more money. D tier, TikTok shop affiliate, honestly good. I've hit multiple five figure months with this. Just sucks that you have to be on camera every day. Violation sucks like you can randomly get banned and lose a ton of money. You're in a constant hamster wheel looking for products. And worst of all you can't really scale, people try to act like you can. But it's really just your old videos making you money. You're not actually scaling. Nonetheless, A tier, A.I. agency, as in selling A.I. to businesses. So honestly a real thing and definitely works, but it kind of has the same losses freelance brand scaling. It's super hard to get one tiny like $1,000 client. You need to know a ton about A.I. and how to implement it. And it's genuinely just way too much work for the amount of money you make. And everyone's doing it already. It's super hard to stand out. B tier, working at Papa Johns. I did this and it sucked. F tier. A.I. avatars. You're an affiliate for an Amazon brand. This is what I do now. So maybe I'm a little biased, but you don't have to show your face. You don't have to learn a lot about A.I. Because the software and tools make the videos for you. The conversions are super high since everyone trusts Amazon. When you work with the brands directly, which is what you have to do. You get 100% commission at least. It is literally the only business model I've seen a mom make $80,000. And a kid make $4,000 this first week. If you want to learn more about this one, look at the videos on my page. If you actually want to join our team and get access to the brands, then click the link in my bio.
...
DM-Followup: pending — comment 'store' to get: Link to try the Amboras platform

A 17-year-old claims that an AI tool called 'Claude Fable 5' combined with a platform called 'Amboras' helped him build and optimize an e-commerce store. He showcases analytics showing $41K+ in gross sales and features like AI-generated store builds, A/B testing, bundles, and subscriptions.

The creator, who says he is 17 and does e-commerce, claims an AI model he calls 'Claude Fable 5' does most of the heavy lifting for his store. He shows a Shopify-like analytics dashboard (branded 'Amboras') displaying $41,329.18 in gross sales, 412 recurring customers, and $64K in total sales by channel. He demonstrates how a single prompt can generate a full store with bundles, subscriptions, upsells, and product imagery. He also highlights an A/B testing feature that supposedly runs 100 variants simultaneously, claiming it boosted his conversion rate by 3.2%. The platform shown is called Amboras, described as a full shop system with orders, products, analytics, emails, A/B testing, and integrations. He ends with a call-to-action asking viewers to comment 'store' to receive a link.

- Claims 'Claude Fable 5' and Amboras platform generate full e-commerce stores from a single prompt
- Shows analytics dashboard with $41,329.18 gross sales and $64K total channel sales
- A/B testing feature allegedly runs 100 store variants and improved conversion rate by 3.2%
- Platform includes bundles, subscriptions, upsells, reviews pages, and integrations
- Creator is 17 and uses this as a primary income source
- Asks viewers to comment 'store' for a referral/affiliate link

⚠️ Reliability (hype: heavy):
- [dubious] 'Claude Fable 5' builds full e-commerce stores from a single prompt — 'Claude Fable 5' is not a real product name — Claude models are named differently and no version called 'Fable 5' exists; this appears to be fabricated or heavily misleading branding.
- [unverifiable] A/B testing 100 store variants increased conversion rate by 3.2% — No evidence or methodology is shown to support this specific conversion lift figure.
- [unverifiable] Store has generated $41,329.18 in gross sales with 412 recurring customers — The dashboard screenshot could be fabricated or belong to someone else; no independent verification is provided.
...
Source: https://www.instagram.com/reel/Da9gI01OYmq/?igsh=NTc4MTIwNjQ2YQ==
Creator: Tristan Natale

A young content creator ranks various online business models in a tier list format (S through F), sharing personal experiences with each. He covers day trading, dropshipping, SMMA/freelancing, TikTok Shop affiliate, AI agency, Papa Johns employment, and Amazon brand affiliating with AI avatars, ultimately pitching his current Amazon affiliate model as the best option.

The creator opens by introducing a tier list ranking of online business models he claims to have personally tried. Day trading gets F tier because it's nearly impossible to learn and most online 'traders' really make money from coaching. Dropshipping gets B tier — it worked for him at 16 but requires expensive ads and many skills gurus don't mention. Freelance brand scaling/SMMA gets D tier due to poor effort-to-income ratio. TikTok Shop affiliate gets A tier despite cons like random bans, camera requirements, and scaling limitations. AI agency gets B tier but has similar issues to SMMA with high difficulty and low pay. Papa Johns gets F tier as a joke. Finally, he pitches AI avatars as an Amazon brand affiliate model (his current business), claiming no face required, high commissions, AI tools handle content creation, and extreme income potential. He directs viewers to his bio link to join his team.

- Day trading is F tier — nearly impossible and most 'gurus' make money from coaching, not trading
- TikTok Shop affiliate is A tier but has scaling limits, ban risks, and requires constant on-camera presence
- Dropshipping is B tier — real but requires ad spend and many skills gurus hide
- AI agency and SMMA/freelancing are rated poorly due to difficult client acquisition and low pay relative to effort
- His top recommendation is Amazon brand affiliating using AI-generated avatars — no face, high commissions, AI tools handle videos
- Claims a mom made $80,000 and a beginner made $4,000 in their first week with his Amazon AI avatar method

⚠️ Reliability (hype: heavy):
- [dubious] A mom made $80,000 and a beginner made $4,000 in their first week using his Amazon AI avatar affiliate method — Extraordinary income claims with no verifiable evidence shown, typical of course/program promotion content.
- [dubious] Amazon brand affiliates get 100% commission when working directly with brands — Standard Amazon affiliate commissions are 1-10%; '100% commission' arrangements would be highly unusual and are not a standard Amazon program feature.
...
## 2026-07-23 03:31 UTC
Source: https://www.instagram.com/reel/DbCCRPvtHtw/?igsh=NTc4MTIwNjQ2YQ==
Creator: erenlovesecom
DM-Followup: pending — comment 'store' to get: Link to the Amboras e-commerce platform

A 17-year-old claims that an AI tool called 'Claude Fable 5' (likely meaning Claude) combined with an e-commerce platform called 'Amboras' helped him build and optimize an online store. He shows analytics dashboards with $41K-$64K in sales and demonstrates features like AI-built storefronts, A/B testing, upsells, and integrations.

The creator opens with hype-bait framing, claiming he's scared to share his secret because too many people will copy him and get rich. He explains he's a 17-year-old doing e-commerce, using Claude AI alongside a platform called Amboras to build and optimize his store. He shows an analytics dashboard showing $41,329.18 in gross sales, 412 recurring customers, 576 orders, and $64K in total sales by channel. He demonstrates that a single AI prompt can generate bundles, subscriptions, upsells, and product imagery. He also shows an A/B testing feature that supposedly tested 100 store variants and increased his conversion rate by 3.2%. He describes Amboras as a full shop system with orders, products, and integrations, and claims the AI can build custom features like a reviews page on demand. The video ends with a call-to-action to comment 'store' to receive a link to the platform.

- Claims to use Claude AI + 'Amboras' platform to build and run an e-commerce store with minimal effort
- Shows analytics dashboard with $41K gross sales and $64K total channel sales
- Demonstrates AI-generated store features: bundles, subscriptions, upsells, product imagery from one prompt
- Claims A/B testing 100 store variants boosted conversion rate by 3.2%
- Positions Amboras as a full shop system with AI-built integrations and pages
- Ends with engagement-bait CTA: comment 'store' for a link

⚠️ Reliability (hype: heavy):
- [dubious] Claude Fable 5 built his entire store from a single prompt including bundles, subscriptions, and upsells — 'Claude Fable 5' is not a real product name; this appears to be a branded/fictional name likely used to promote Amboras, and the capability described is exaggerated.
- [unverifiable] A/B testing 100 store variants increased conversion rate by 3.2% — The specific figure is shown briefly on screen with no methodology, timeframe, or baseline conversion rate provided to validate the claim.
- [unverifiable] Store is generating $41,329–$64,000 in sales as shown in the analytics dashboard — Screenshots can be fabricated or represent a demo/test account; there is no independent verification of these figures.
